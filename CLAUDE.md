...
| #   | Fayl                                                                             | Nima uchun                                  |
| --- | -------------------------------------------------------------------------------- | ------------------------------------------- |
| 1   | `../Projects-FinTech/CLAUDE.md`                                                  | Vault umumiy qoidalari                      |
...
### Yangi ekran
**Skill:** `.claude/skills/01 - Ekran yaratish.md` (avto-yuklangan)
...
**Skill:** `.claude/skills/02 - Riverpod provider.md`
...
## 🛠️ O'rnatilgan skill'lar (`.claude/skills/`)
